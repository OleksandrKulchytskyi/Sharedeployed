...
namespace ShareDeployed.Common.Proxy.FastReflection
{
	public class PropertyAccessor : IPropertyAccessor
	{
		...
		public PropertyAccessor(Type targetType, string property)
		{
			...
			{
				throw new PropertyAccessorException(string.Format("Property \"{0}\" does not exist for type {1}.", property, targetType));
			}
			else
			{
		...
		public object Get(object target)
		{
			...
			{
				throw new PropertyAccessorException(string.Format("Property \"{0}\" does not have a get method.", mProperty));
			}
		}
		...
		public void Set(object target, object value)
		{
			...
			{
				throw new PropertyAccessorException(string.Format("Property \"{0}\" does not have a set method.", mProperty));
			}
		}
		...
		private void Init()
		{
			...
			if (mEmittedPropertyAccessor == null)
				throw new Exception("Fail to create property accessor.");
		}
