...
namespace ShareDeployed.Common.Proxy
{
	...
	public static class InterfaceObjectFactory
	{
		...
		private static void CreateTypeFor(Type type)
		{
			...
			TypeBuilder typeBuilder = ModuleBuilder.DefineType("ImplOf" + type.Name, TypeAttributes.Class | TypeAttributes.Public);
			...
			foreach (PropertyInfo pi in properties)
			{
				...
				if (null != getMethod)
				{
					...
					MethodBuilder methodBuilder = typeBuilder.DefineMethod(getMethod.Name,
						MethodAttributes.Public | MethodAttributes.Virtual, propertyType, Type.EmptyTypes);
				...
				if (null != setMethod)
				{
					...
					typeBuilder.DefineMethod(setMethod.Name, MethodAttributes.Public | MethodAttributes.Virtual, typeof(void), new Type[] { pi.PropertyType });
			...
			foreach (MethodInfo methodInfo in methods)
			{
				...
				MethodBuilder methodBuilder = typeBuilder.DefineMethod(methodInfo.Name,
					MethodAttributes.Public | MethodAttributes.Virtual, returnType, argumentTypes.ToArray());
