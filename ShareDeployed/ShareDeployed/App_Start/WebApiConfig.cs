...
namespace ShareDeployed
{
	public static class WebApiConfig
	{
		public static void Register(HttpConfiguration config)
		{
			...
			config.Routes.MapHttpRoute(name: "WordsGetComplexity",
					routeTemplate: "api/{controller}/{action}/{complex}",
					defaults: new { controller = "Words", action = "GetComplexity", complex = RouteParameter.Optional }
			);
