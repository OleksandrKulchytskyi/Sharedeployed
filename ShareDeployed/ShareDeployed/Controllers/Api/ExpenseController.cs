...
namespace ShareDeployed.Controllers.Api
{
	...
	public class ExpenseController : ApiController
	{
		...
		//		if (_userId == 0 && Request.Headers.Contains("UserId"))
		//			_userId = Int32.Parse(Request.Headers.GetValues("UserId").First());

		//		time2 = time2.AddDays(1);
		//		return _expenseRepository.GetAll(x => (x.Time >= time1.Date && x.Time <= time2) && x.UserId == _userId);
		//	}
		//	catch (Exception ex)
		//	{
		//		MvcApplication.Logger.Error("GetAll", ex);
